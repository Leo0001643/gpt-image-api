...
//
// env：
//   GIA_PROVIDER_GPT  = "real" | "mock"   (默认 mock)
//   GIA_PROVIDER_GROK = "real" | "mock"   (默认 mock)
//   GIA_GPT_BASE_URL  = 默认 base url（账号未配置 base_url 时使用）
//   GIA_GROK_BASE_URL = 默认 base url
//
...
import (
	...
	"github.com/gpt-image-api/backend/internal/provider/gpt"
	"github.com/gpt-image-api/backend/internal/provider/grok"
	"github.com/gpt-image-api/backend/internal/provider/mock"
)
